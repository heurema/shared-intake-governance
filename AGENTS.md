...
validated dry-run, validated execution mediation, provider request, provider
result, explicit governed tool execution with validated result writes, and
explicit provider command invocation runtime slices.
