...
clean-record emitter, one explicit-profile JSON projector, and one narrow local
CLI command for the current `github_repo` path with run manifest and source
health output.
